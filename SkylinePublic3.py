...
cl.login(token='')
cl.loginResult()
print "SKYLINE BOT SUKSES LOGIN"
...
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘ âº ã€˜Admin add @ã€™
â•‘ âº ã€˜Admin remove @ã€™
â•‘ âº ã€˜Crashã€™
â•‘ âº ã€˜Kickallã€™
â•‘ âº ã€˜Bc: (Text)ã€™
â•‘ âº ã€˜Join group: (NamaGroupã€™
â•‘ âº ã€˜Leave group: (NamaGroupã€™
â•‘ âº ã€˜Leave all groupã€™
â•‘ âº ã€˜Tag on/offã€™
â•‘ âº ã€˜Bot restartã€™
â•‘ âº ã€˜Turn offã€™
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
"""
...
â•‘ âº ã€˜Killã€™
â•‘ âº ã€˜Kick @ã€™
â•‘ âº ã€˜Set member: (Jumblah)ã€™
â•‘ âº ã€˜Ban group: (NamaGroupã€™
â•‘ âº ã€˜Del ban: (NamaGroupã€™
â•‘ âº ã€˜List banã€™
â•‘ âº ã€˜Kill banã€™
â•‘ âº ã€˜Glistã€™
â•‘ âº ã€˜Glistmidã€™
â•‘ âº ã€˜Details group: (Gid)ã€™
â•‘ âº ã€˜Cancel invite: (Gid)ã€™
â•‘ âº ã€˜Invitemeto: (Gid)ã€™
â•‘ âº ã€˜Acc inviteã€™
â•‘ âº ã€˜Removechatã€™
â•‘ âº ã€˜Qr on/offã€™
â•‘ âº ã€˜Autokick on/offã€™
â•‘ âº ã€˜Ghost on/offã€™
â•‘ âº ã€˜Autocancel on/offã€™
â•‘ âº ã€˜Invitepro on/offã€™
â•‘ âº ã€˜Join on/offã€™
â•‘ âº ã€˜Joincancel on/offã€™
â•‘ âº ã€˜Respon on/offã€™
â•‘ âº ã€˜Responkick on/offã€™
â•‘ âº ã€˜Removechatã€™
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
"""
...
helpMessage ="""
â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘       â˜† Æ“ÆÐ›Æ“ã‚‰Å¤Æå°ºÏ¦Ã˜Å¤ â˜†
â• â•â•â•â•â•â• HELP â•â•â•â•â•â•
â• âž©ã€˜Help publikã€™
â• âž©ã€˜Help botã€™
â• âž©ã€˜Help groupã€™
â• âž©ã€˜Help setã€™
...
â•‘ bot ini dibuat hanya
â•‘ untuk bersenang - senang
â•‘ jika kalian menemukan bug
â•‘ silahkan screenshot
â•‘ kirim ke admin
â•‘ untuk melihat contac admin
â•‘ ketik "admin"
â•‘ Terimakasih
...
admin=["ucad303333969352466bfecd62089a1b4","u5171f59b07a3155c7fd3fd6e7e5862a2"]
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    for v in range(len(recheckData)):
                        ...
                        pass
                    if len(dataResult) > 0:
                        tukang = "â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\nâ•‘         â˜†â˜ž LIST VIEWERS â˜œâ˜†\nâ• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\nâ• âž©"
...
#               cl.sendText(msg.to, "Progress...")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "RAHMAT,'"}
                cl.sendMessage(msg)

...
targets = []
Bots=[mid]
admin = ["u186a37ba393c1e4870b94b063d96232b"]
owner = ["u186a37ba393c1e4870b94b063d96232b"]
wait = {
    'contact':False,
    'autoJoin':True,
                ...
                if Amid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("client ãŒè¹´ã‚Šè¦åˆ¶orã‚°ãƒ«ãƒ¼ãƒ—ã«å­˜åœ¨ã—ãªã„ç‚ºã€\n["+op.param1+"]\nã®\n["+op.param2+"]\nBecause the client does not exist in the kick regulation or group.\nAdd it to the blacklist.")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
...
#------------------------------------------------
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
                kk.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
                kc.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
		ks.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
		kt.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
		cl.sendText(msg.to,"PONG ô€¨ô€„»double thumbs upô€œô€…”Har Har")
